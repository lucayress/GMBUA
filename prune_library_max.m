function [B, index_kept] = prune_library_max(A,max_angle)
%        B = prune_library_max(A,max_angle)
%
...
% discard vectors with angles more than max_angle
index = 1;
index_kept = [];
